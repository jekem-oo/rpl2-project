...
@section('title', 'Laporkan Barang Ditemukan - Lost & Found')
            ...
            <div class="card">
                <div class="card-body p-4 p-md-5">
                    ...
                    <div class="text-center mb-5">
                        ...
                        <h2 class="section-title mb-2">Laporkan Barang Ditemukan</h2>
                        <p class="text-muted mb-0">Bantu temukan pemilik barang yang Anda temukan</p>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="form-floating mb-3">
                            ...
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            <div class="form-text">Jelaskan ciri-ciri khusus barang agar mudah dikenali pemiliknya</div>
                        </div>
                        ...
                        <div class="form-floating mb-3">
                            ...
                            <label for="location">Lokasi Ditemukan <span class="text-danger">*</span></label>
                            @error('location')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-floating mb-3">
                            ...
                            <label for="date">Tanggal Ditemukan <span class="text-danger">*</span></label>
                            @error('date')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="d-flex gap-3">
                            ...
                            <button type="submit" class="btn btn-success flex-fill">
                                <i class="bi bi-check-lg me-2"></i>Kirim Laporan
                            </button>
                        </div>
                    </form>
                </div>
